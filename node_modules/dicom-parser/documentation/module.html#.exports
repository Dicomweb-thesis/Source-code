...
<header>
        ...
        exports
            ...
            <div class="class-description">Constructs a new DataSet given byteArray and collection of elements</div>
...
<article>
    ...
    <h4 class="name" id=".exports"><span class="type-signature"></span>new exports<span class="signature">(byteArrayParser, byteArray, elements)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="dataSet.js.html">dataSet.js</a>, <a href="dataSet.js.html#line35">line 35</a>
    </li></ul></dd>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>byteArrayParser</code></td>
        ...
        <tr>
                ...
                <td class="name"><code>byteArray</code></td>
...
<header>
        ...
        exports
            ...
            <div class="class-description">Constructor for ByteStream objects.</div>
...
<article>
    ...
    <h4 class="name" id=".exports"><span class="type-signature"></span>new exports<span class="signature">(byteArrayParser, byteArray, position)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="byteStream.js.html">byteStream.js</a>, <a href="byteStream.js.html#line24">line 24</a>
    </li></ul></dd>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last">a parser for parsing the byte array</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">a Uint8Array containing the byte stream</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">(optional) the position to start reading from.  0 if not specified</td>
        </tr>
...
<ul>
    ...
    <div class="param-desc">
        ...
        will throw an error if the byteArrayParser parameter is not present
    ...
    <div class="param-desc">
        ...
        will throw an error if the byteArray parameter is not present or invalid
    ...
    <div class="param-desc">
        ...
        will throw an error if the position parameter is not inside the byte array
