...
<head>
    <meta charset="utf-8">
    <title>util/dataSetToJS.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">util/dataSetToJS.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import explicitElementToString from './elementToString';
