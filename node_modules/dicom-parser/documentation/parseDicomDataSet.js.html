...
<head>
    <meta charset="utf-8">
    <title>parseDicomDataSet.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">parseDicomDataSet.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import readDicomElementExplicit from './readDicomElementExplicit';
