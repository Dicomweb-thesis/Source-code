...
<head>
    <meta charset="utf-8">
    <title>readDicomElementExplicit.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">readDicomElementExplicit.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import findEndOfEncapsulatedElement from './findEndOfEncapsulatedPixelData';
