...
<head>
    <meta charset="utf-8">
    <title>readSequenceItem.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">readSequenceItem.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import readTag from './readTag';
