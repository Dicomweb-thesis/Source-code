...
<html lang="en">
<head>
    <title>Code coverage report for src/dataSet.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> dataSet.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { readFixedString } from './byteArrayParser.js';
&nbsp;
/**
 *
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (numMatching === null) {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (index &gt;= 0) {
        var values = <span class="cstat-no" title="statement not covered" >fixedString.split('\\');</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >        return values[index].replace(/ +$/, '');</span>
      }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (element &amp;&amp; element.length &gt; 0) {
      index = (index !== undefined) ? <span class="branch-0 cbranch-no" title="branch not covered" >index </span>: 0;
      var value = this.string(tag, index);
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (value !== undefined) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (element &amp;&amp; element.length === 4) {
