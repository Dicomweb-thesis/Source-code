...
<html lang="en">
<head>
    <title>Code coverage report for src/sharedCopy.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> sharedCopy.js
    </h1>
    <div class='clearfix'>
...
export default function sharedCopy (byteArray, byteOffset, length) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof Buffer !== 'undefined' &amp;&amp; byteArray instanceof Buffer) {
<span class="cstat-no" title="statement not covered" >    return byteArray.slice(byteOffset, byteOffset + length);</span>
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (byteArray instanceof Uint8Array) {
    return new Uint8Array(byteArray.buffer, byteArray.byteOffset + byteOffset, length);
  }
<span class="cstat-no" title="statement not covered" >  throw 'dicomParser.from: unknown type for byteArray';</span>
}
&nbsp;</pre></td></tr>
</table></pre>
