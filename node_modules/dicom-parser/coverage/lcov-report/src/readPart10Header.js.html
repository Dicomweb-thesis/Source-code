...
<html lang="en">
<head>
    <title>Code coverage report for src/readPart10Header.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> readPart10Header.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">3×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import ByteStream from './byteStream.js';
...
<span class="cstat-no" title="statement not covered" >    throw 'dicomParser.readPart10Header: missing required parameter \'byteArray\'';</span>
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (prefix !== 'DICM') {
<span class="cstat-no" title="statement not covered" >      throw 'dicomParser.readPart10Header: DICM prefix not found at location 132 - this is not a valid DICOM P10 file.';</span>
    }
  }
&nbsp;
  // main function here
