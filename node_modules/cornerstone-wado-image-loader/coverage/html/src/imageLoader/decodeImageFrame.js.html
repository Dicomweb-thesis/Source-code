...
<html lang="en">
<head>
    <title>Code coverage report for src/imageLoader/decodeImageFrame.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/imageLoader/</a> decodeImageFrame.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import webWorkerManager from './webWorkerManager.js';
...
function addDecodeTask (imageFrame, transferSyntax, pixelData, options) {
  ...
  const transferList = options.transferPixelData ? <span class="branch-0 cbranch-no" title="branch not covered" >[pixelData.buffer] </span>: undefined;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return addDecodeTask(imageFrame, transferSyntax, pixelData, options);</span>
...
<span class="cstat-no" title="statement not covered" >      return decodeJPEGBaseline8BitColor(imageFrame, pixelData, canvas);</span>
    }
&nbsp;
    return addDecodeTask(imageFrame, transferSyntax, pixelData, options);
