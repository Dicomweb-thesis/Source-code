...
<html lang="en">
<head>
    <title>Code coverage report for src/imageLoader/wadouri/metaData/metaDataProvider.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">src/imageLoader/wadouri/metaData/</a> metaDataProvider.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (type === 'generalSeriesModule') {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (type === 'patientStudyModule') {
<span class="cstat-no" title="statement not covered" >    return {</span>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (pixelSpacing) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (imageOrientationPatient) {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (type === 'sopCommonModule') {
    return {
...
<span class="cstat-no" title="statement not covered" >  if (type === 'petIsotopeModule') {</span>
    const radiopharmaceuticalInfo = <span class="cstat-no" title="statement not covered" >dataSet.elements.x00540016;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (radiopharmaceuticalInfo === undefined) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    const firstRadiopharmaceuticalInfoDataSet = <span class="cstat-no" title="statement not covered" >radiopharmaceuticalInfo.items[0].dataSet;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >    return {</span>
